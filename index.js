...
app.get("/random", async (req, res)=>{
 try{
    const response = await axios.get("/random")
      console.log("Joke found:", response.data);
...
apppp.get("/jokes/:id", async (req, res) => {
  const id = req.params.id;
  try {
    const response = await axios.get(`/jokes/${id}`);
    console.log("Found joke:", response.data);
    res.json(response.data);
  } catch (error) {
    console.error("Error fetching joke:", error.response.data);
  }
});
...
app.get("/jokes/:type", async (req, res) => {
  ...
  try {
    const response = await axios.get(`jokes/type/${type}`);
    console.log("Found joke:", response.data);
    res.json(response.data);
  } catch (error) {
    console.error("Error fetching joke:", error.response.data);
